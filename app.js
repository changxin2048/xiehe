...
const studentData = {
  ...
  '2019': {
    students: ['余伟杰','韩彦杰','胡圣懿','朱振宸', '杜丰禾', '林垦彤', '刘立洋', '咸晓梦', '鲍欣淼', '张雨薇', '杨芳涵', '董袭莹', '张立佳', '杨盛旻'],
    alternates: []
  },
  '2020': {
    students: ['金山木','王婧桥', '林昱熙', '王路易', '谢雪鹤', '王悠', '李若晨', '钟晓莹', '韩佳澍', '刘明娟', '刘蕴欣', '刘柯', '刘玉晓', '李诗琪'],
    alternates: []
  },
  '2021': {
  ...
  '2024': {
    students: ['肖霄', '蔡正浩', '张昕奕', '王纳川', '金怡杉', '毛忠琪', '段骁涵', '李飞宇', '方文昊', '朱嘉悦', '尚得昕', '王涵', '李帅鑫', '卫昱辰', '边书阳', '李少杨', '纪琳佳', '刘雨菲', '冯暖曦','梁亦轲', '邱靖涵', '马嘉明', '方文昊', '陈尔真', '姜楠', '葛欣阳', '庞玥茵', '张靖岳', '李心慧', '李宇翔', '王玮奇', '姚翔'],
    alternates: []
  },
  '2025': {
    students: ['闫宸', '张丹', '罗胜聪', '刘丛语', '李雨江', '张博栋', '肖荟尹', '沈跃然', '王铭萱', '姜博茏', '蒋馨欧', '陈佳善', '乔伟', '李航', '罗浥瑄', '吴淳炜', '郑歆瑶', '朱成林', '梁宇腾', '马语嫣', '盛玺澄', '郭睿宁', '李航', '张何睿', '周纪元', '吴佳蕙', '王麓淇', '杨子杆', '李想', '陈琪', '冉涛', '冯笑与', '李瑞恩', '易润杰', '张博栋', '柴元皓', '彭嘉宁', '张鹤议', '王天皓', '曹喆'],
    alternates: []
  },
  '2026': {
